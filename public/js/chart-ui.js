...
// =========================================================================
// ⚙️ BƯỚC 3: CHART SETTINGS MODAL (ĐÃ PHỤC HỒI NGUYÊN BẢN & BỔ SUNG ĐẦY ĐỦ PRO)
// =========================================================================
(function initChartSettingsModal() {
    ...
    // 🚀 LOGIC ĐỘNG: QUẢN LÝ ẨN HIỆN CÁC UI CÀI ĐẶT
    ...
    // Cỗ máy event listener siêu việt của bạn
    modal.querySelectorAll('[data-bind]').forEach(el => {
    ...
    // NGUYÊN BẢN CỦA BẠN: GẮN NÚT VÀO TOOLBAR
    const checkToolbar = setInterval(() => {
