...
// ─────────────────────────────────────────────
  ...
  function openTextEditor(currentText, currentStyles, toolId, onConfirm) {
    ...
    if (toolId === 'plainText' || toolId === 'insertIcon' || toolId === 'insertImage') defBg = 'transparent'; // Text thường thì nền rỗng
