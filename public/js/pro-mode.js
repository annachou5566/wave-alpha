    ...
    hud.innerHTML = `
        <div class="hud-grid-main">
            <div class="hud-card">
                ...
                <div style="display:flex; justify-content:space-between; font-size:10px; font-weight:700; margin-bottom:4px; font-family:var(--font-num);">
        ...
        <div class="hud-grid-movers">
            <div class="hud-card" style="min-height:auto;">
                <div class="hud-title" style="color:#0ecb81; margin-bottom:10px;">TOP GAINERS</div>
                <div class="trend-col">
                    ${topGainers.map(t => renderTrendItem(t, 'gain')).join('')}
                </div>
            </div>
            <div class="hud-card" style="min-height:auto;">
                <div class="hud-title" style="color:#f6465d; margin-bottom:10px;">TOP LOSERS</div>
                <div class="trend-col">
