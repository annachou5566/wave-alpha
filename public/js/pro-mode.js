...
// ========================================================
    ...
    if (!document.getElementById('wave-alpha-pro-chart-styles')) {
        ...
        proChartStyle.innerHTML = `
            #super-chart-overlay { height: 100dvh !important; padding-bottom: 25px; box-sizing: border-box; background: rgba(8, 10, 14, 0.98); backdrop-filter: blur(15px); font-family: var(--font-main); }
...
window.openProChart = function(t, isTimeSwitch = false) {
    ...
    setTimeout(() => {
        ...
        new ResizeObserver(entries => {
            ...
            if (newRect.width > 0 && newRect.height > 0) tvChart.applyOptions({ height: Math.max(0, newRect.height - 20), width: newRect.width });
        }).observe(container);
